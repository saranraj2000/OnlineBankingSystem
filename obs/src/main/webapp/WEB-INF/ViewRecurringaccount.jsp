...
<c:choose>
       ...
       <tr>
        ...
        <td>${recu.branch}</td>
        <td>${recu.ifsc}</td>
        <td>${recu.instalmentamount}</td>
        <td>${recu.tenure}</td>
        <td>${recu.modeofoperation}</td>
        <td>${recu.maturitydate}</td>
        <td><a href="/deleterecurring?accno=${recu.accno}">Close Account</a></td>
       </tr>
       </c:forEach>
       </tbody>
       </table>
